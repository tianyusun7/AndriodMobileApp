...
// recycler view -> view group
// adapter -> ViewHolder(item view)
// LayoutManager
public class SavedNewsAdapter extends RecyclerView.Adapter<SavedNewsAdapter.SavedNewsViewHolder> {
    interface ItemCallback {//connect with save fragment
        void onOpenDetails(Article article);
        void onRemoveFavorite(Article article);
    } //use an interface instead of directly using fragment or viewModel
